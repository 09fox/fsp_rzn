...
typedef enum e_bsp_reset
{
    ...
    BSP_RESET_CA55_0 = 2,              ///< Software reset for CA55_0
    BSP_RESET_CA55_1 = 3,              ///< Software reset for CA55_1
    BSP_RESET_CA55_2 = 4,              ///< Software reset for CA55_2
    BSP_RESET_CA55_3 = 5,              ///< Software reset for CA55_3
} bsp_reset_t;
