...
#else
 #define BSP_MSTP_DMY_FSP_IP_TSU(channel)           R_TSU->SSR;
#endif
...
#define BSP_MSTP_DMY_FSP_IP_RTC(channel)            R_RTC->RTCA0CTL0;
 ...
 #define BSP_MSTP_DMY_FSP_IP_CA55(channel)          (0 == channel) ? R_CA55->RVBAL0 : \
    ((1 >= channel) ? R_CA55->RVBAL1 :                                                \
     ((2 >= channel) ? R_CA55->RVBAL2 :                                               \
      R_CA55->RVBAL3))
#endif
